...
else if(g6.getState()==true)
{
w4="NORMAL INJURED";
}
else if(g7.getState()==true)
{
w5="SERIOUS INJURED";
}
}
...
try
{
pst=con.prepareStatement("insert into Infoabacci values('"+q1+"','"+q2+"','"+q3+"','"+q4+"','"+q5+"','"+q6+"','"+q7+"','"+q8+"','"+q9+"','"+w1+"','"+w2+"','"+w3+"','"+w4+"','"+w5+"')");
pst.executeUpdate();
}
...
{
DemoAddArea obj=new DemoAddArea();
obj.setID(t2.getText());
obj.setUpDemoAddArea();
}
