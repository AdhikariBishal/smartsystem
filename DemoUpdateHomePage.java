...
public class DemoUpdateHomePage extends Frame implements ActionListener 
{
Connection con;
Statement st;
...
public void setUpDemoUpdateHomePage()
{
frm.setLayout(null);
...
try
{
pst=con.prepareStatement("update newArearec set policestanum='"+a2+"',ambunum='"+a3+"',firestanum='"+a4+"' where areaname='"+a1+"'");
pst.executeUpdate();
}
