...
public class DemoCaller extends Frame implements ActionListener 
{
Connection con;
...
b1=new Button("Search Rec");
b2=new Button("Print Rec");
...
DemoEmergencyCall obj=new DemoEmergencyCall();
obj.setUpDemoEmergencyCall();

}

if(ae.getSource()==b4)
{
DemoSearchChildren obj=new DemoSearchChildren();
obj.setID(t1.getText());
obj.setUpDemoSearchChildren();
}

if(ae.getSource()==b5)
{
DemoSearchPoliceStationInfo obj=new DemoSearchPoliceStationInfo();
obj.setID(t8.getText());
obj.setUpDemoSearchPoliceStationInfo();
}

if(ae.getSource()==b6)
{
DemoSearchHospital obj=new DemoSearchHospital();
obj.setID(t1.getText());
obj.setUpDemoSearchHospital();
}

if(ae.getSource()==b7)
{
DemoSearchFireStationInfo obj=new DemoSearchFireStationInfo();
obj.setID(t1.getText());
obj.setUpDemoSearchFireStationInfo();
}

if(ae.getSource()==b8)
{
DemoSearchPowerStationInfo obj=new DemoSearchPowerStationInfo();
obj.setID(t1.getText());
obj.setUpDemoSearchPowerStationInfo();
}

if(ae.getSource()==b9)
{
DemoInfoAboutAccident obj=new DemoInfoAboutAccident();
obj.setID(t1.getText());
obj.setUpDemoInfoAboutAccident();
}
