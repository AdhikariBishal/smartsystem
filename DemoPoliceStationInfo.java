...
public class DemoPoliceStationInfo extends Frame implements ActionListener 
{
Connection con;
Statement st;
...
l10=new Label("NAME OF POLICE STATION");
...
public void setUpDemoPoliceStationInfo()
{
frm.setLayout(null);
...
try
{
pst=con.prepareStatement("insert into policestainfo values('"+a1+"','"+a2+"','"+a3+"','"+a4+"','"+a5+"','"+a6+"','"+a7+"','"+a8+"')");
pst.executeUpdate();
}
...
conn();
putData();
DemoPowerStationInfo obj=new DemoPowerStationInfo();
obj.setID(t1.getText());
obj.setUpDemoPowerStationInfo();
