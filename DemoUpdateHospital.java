...
public class DemoUpdateHospital extends Frame implements ActionListener
{
Connection con;
Statement st;
...
public void setUpDemoUpdateHospital()
{
...
b1.setBounds(450,400,150,25);
b2.setBounds(750,400,150,25);
b3.setBounds(600,500,150,25);
...
try
{
pst=con.prepareStatement("update hosinfo set nameofhos='"+a2+"',nameofhos2='"+a3+"',ambunum='"+a4+"',dis1='"+a5+"',dis2='"+a6+"',hospnum1='"+a7+"',hospnum2='"+a8+"' where emernum='"+a1+"' ");
pst.executeUpdate();
}
